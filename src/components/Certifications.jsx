...
const certs = [
    ...
    {
        title: 'JavaScript, Node.js, Express & MySQL',
    ...
    return (
        <section id="certifications" className="py-24 section-tinted">
            <div className="max-w-4xl mx-auto px-6" ref={ref}>
                ...
                >
                   <span className="text-indigo-400 text-sm font-semibold uppercase tracking-widest">Learning Path</span>
<h2 className="text-4xl font-extrabold text-white mt-2">
    Learning &amp; <span className="gradient-text">Strengths</span>
</h2>
                </motion.div>
