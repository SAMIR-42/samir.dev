...
const contactInfo = [
    {
        ...
        label: 'Phone',
        value: '+91-7499144851',
        href: 'tel:+917499144851',
        color: 'from-blue-500 to-indigo-500',
    },
    {
        icon: FiMail,
        label: 'Email',
        value: 'samirpatil1626@gmail.com',
        href: 'mailto:samirpatil1626@gmail.com',
        color: 'from-indigo-500 to-violet-500',
    },
    {
        icon: FiLinkedin,
        label: 'LinkedIn',
        value: 'linkedin.com/in/samirpatil-',
        href: 'https://www.linkedin.com/in/samirpatil-/',
        color: 'from-violet-500 to-purple-500',
    },
    {
        icon: FiGithub,
        label: 'GitHub',
        value: 'github.com/SAMIR-42',
        href: 'https://github.com/SAMIR-42',
