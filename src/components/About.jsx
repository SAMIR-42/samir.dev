...
export default function About() {
    ...
    <div className="w-52 h-52 rounded-3xl overflow-hidden border border-indigo-500/20 shadow-2xl shadow-indigo-500/30 group">
    <img
        src="/spic.jpg"
        alt="Profile"
        ...
        <FiCode className="text-indigo-400" size={28} />
                    ...
                    >
                        <p className="text-slate-300 text-lg leading-relaxed">
                            Hi! I'm <strong className="text-white">SAMIR PATIL</strong>, a final-year B.sc Computer Science student at Arts, Commerce and Science College Maregaon, Maharashtra
                        </p>
                        <p className="text-slate-400 leading-relaxed">
                            I'm passionate about full-stack web development and enjoy crafting clean, scalable
                            applications that solve real-world problems. I have hands-on experience with Javascript,
                        ...
                        <div className="flex gap-4 pt-2">
                            {[['5+', 'Projects'], ['0', 'Internships'], ['7.09', 'CGPA']].map(([val, label]) => (
